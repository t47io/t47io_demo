                ...
                success: function (data) {
                    ...
                    setTimeout(function() {
                        ...
                        for (var i = 0; i < data.ec2.length; i++) {
                            ...
                            html += '<div class="row" id="ec2-' + data.ec2[i].name + '"><div class="col-lg-9 col-md-9 col-sm-9 col-xs-9"><p><span class="lead">' + ec2 + '&nbsp;&nbsp;<b><u>' + data.ec2[i].name + '</u></b></span>&nbsp;&nbsp;<span class="label label-orange">' + data.ec2[i].id + '</span>&nbsp;<span class="label label-primary">' + data.ec2[i].type + '</span>&nbsp;<span class="label label-info">' + data.ec2[i].arch + '</span>&nbsp;<span class="label label-violet">' + data.ec2[i].region + '</span></p><p><a href="http://' + data.ec2[i].dns + '" target="_blank" rel="noopener noreferrer external"><code>' + data.ec2[i].dns + '</code></a></p></div><div class="col-lg-3 col-md-3 col-sm-3 col-xs-3"><p class="text-right"><span class="label label-inverse">Credits Balance</span></p><p class="text-right"><i><mark>' + data.ec2[i].credit + '</mark></i></p></div></div><div class="row"><div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><div id="plot_cpu_' + data.ec2[i].id + '" class="thumbnail place_holder" style="padding:0px 20px; height: 150px;"></div></div><div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><div id="plot_net_' + data.ec2[i].id + '" class="thumbnail place_holder" style="padding:0px 20px; height: 150px;"></div></div></div>';
                    ...
                    setTimeout(function() {
                        ...
                        for (var i = 0; i < data.elb.length; i++) {
                            ...
                            html += '<div class="row" id="elb-' + data.elb[i].name + '"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><p><span class="lead">' + elb + '&nbsp;&nbsp;<b><u>' + data.elb[i].name + '</u></b></span>&nbsp;&nbsp;<span class="label label-orange">' + data.ec2[i].id + '</span>&nbsp;<span class="label label-primary">' + data.ec2[i].type + '</span>&nbsp;<span class="label label-info">' + data.ec2[i].arch + '</span>&nbsp;<span class="label label-violet">' + data.elb[i].region + '</span></p><p><a href="http://' + data.elb[i].dns + '" target="_blank" rel="noopener noreferrer external"><code>' + data.elb[i].dns + '</code></a></p></div></div><div class="row"><div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><div id="plot_lat_' + data.elb[i].name + '" class="thumbnail place_holder" style="padding:0px 20px; height: 150px;"></div></div><div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><div id="plot_req_' + data.elb[i].name + '" class="thumbnail place_holder" style="padding:0px 20px; height: 150px;"></div></div></div>';
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    for (var i = 0; i < data.owners.length; i++) {
                        presence = (data.owners[i].presence) ? '<span style="color: #50cc32;"': '<span>';
                        html += '<tr><td><span class="pull-right"><span class="label label-danger">' + data.owners[i].id + '</span>&nbsp;&nbsp;' + presence + '<span class="glyphicon glyphicon-registration-mark"></span></span></span></td><td><div class="sprite" style="height:24px; width:24px;"><div class="avatar_' + data.owners[i].id + '"></div></div>&nbsp;&nbsp;<i>' + data.owners[i].name + '</i></td></tr>';
                    }
                    for (var i = 0; i < data.admins.length; i++) {
                        presence = (data.admins[i].presence) ? '<span style="color: #50cc32;"': '<span>';
                        html += '<tr><td><span class="pull-right"><span class="label label-success">' + data.admins[i].id + '</span>&nbsp;&nbsp;' + presence + '<span class="glyphicon glyphicon-copyright-mark"></span></span></span></td><td><div class="sprite" style="height:24px; width:24px;"><div class="avatar_' + data.admins[i].id + '"></div></div>&nbsp;&nbsp;<i>' + data.admins[i].name + '</i></td></tr>';
                    }
                    for (var i = 0; i < data.users.length; i++) {
                        presence = (data.users[i].presence) ? '<span style="color: #50cc32;"': '<span>';
                        html += '<tr><td><span class="pull-right"><span class="label label-violet">' + data.users[i].id + '</span>&nbsp;&nbsp;' + presence + '<span class="glyphicon glyphicon-ok-circle"></span></span></span></td><td><div class="sprite" style="height:24px; width:24px;"><div class="avatar_' + data.users[i].id + '"></div></div>&nbsp;&nbsp;<i>' + data.users[i].name + '</i></td></tr>';
                    }
                    html += '<tr><td colspan="2" style="padding: 0px;"></td></tr>';
                    for (var i = 0; i < data.gones.length; i++) {
                        presence = (data.gones[i].presence) ? '<span style="color: #50cc32;"': '<span>';
                        html += '<tr class="active"><td><span class="pull-right"><span class="label label-default">' + data.gones[i].id + '</span>&nbsp;&nbsp;' + presence + '<span class="glyphicon glyphicon-ban-circle"></span></span></span></td><td><div class="sprite" style="height:24px; width:24px;"><div class="avatar_' + data.gones[i].id + '"></div></div>&nbsp;&nbsp;<i>' + data.gones[i].name + '</i></td></tr>';
                    }
                    html += '<tr><td colspan="2" style="padding: 0px;"></td></tr>';
