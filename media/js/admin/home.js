$(document).ready(function() {
  ...
  $.ajax({
    ...
    $("#sys_stat").on("click", function(e) {
        e.preventDefault();
        $("#sys-head").html("System Statistics");
        $("#sys-msg").html("The system will refresh version statistics at back stage.");
        $("#sys-modal").modal("show");
        setTimeout(function() { $("#sys-modal").modal("hide"); }, 2000);
    });
    $(".dash_stat").on("click", function(e) {
        e.preventDefault();
        $("#sys-head").html("Cache Results");
        $("#sys-msg").html("The system will cache service/server statistics at back stage.");
        $("#sys-modal").modal("show");
        setTimeout(function() { $("#sys-modal").modal("hide"); }, 2000);
    });
