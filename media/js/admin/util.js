if (app.page == "backup") {
    ...
    $("#backup_now").on("click", function(e) {
        e.preventDefault();
        $("#sys-head").html("Backup Now");
        $("#sys-msg").html("The system will perform backup at back stage.");
        $("#sys-modal").modal("show");
        setTimeout(function() { $("#sys-modal").modal("hide"); }, 2000);
    });
    $("#upload_now").on("click", function(e) {
        e.preventDefault();
        $("#sys-head").html("Upload Now");
        $("#sys-msg").html("The system will perform upload at back stage.");
        $("#sys-modal").modal("show");
        setTimeout(function() { $("#sys-modal").modal("hide"); }, 2000);
    });
    $("#backup_stat").on("click", function(e) {
        e.preventDefault();
        $("#sys-head").html("Backup Statistics");
        $("#sys-msg").html("The system will refresh backup statistics at back stage.");
        $("#sys-modal").modal("show");
        setTimeout(function() { $("#sys-modal").modal("hide"); }, 2000);
    });
