...
head.load('https://cdnjs.cloudflare.com/ajax/libs/jquery/' + app.js_ver.jquery + '/jquery.min.js', function() {
    head.test(window.$, [''], ['/site_media/js/jquery.min.js'], function(flag) {
        ...
        app.isCDN = flag;
        $("head").append('<link rel="shortcut icon" type="image/gif" href="/site_media/images/icon_t47.png" />');
        $("head").append('<link rel="icon" type="image/gif" href="/site_media/images/icon_t47.png" />');
