...
app.fnChangeView = function() {
  ...
  if (path.indexOf('/signin') != -1) {
    ...
    $('<ul id="sys-ul" style="text-align:left;"><li><b>Mock-up</b> <i><u>charts, tables and data entries</u></i> are used for demonstration.</li><li><i><u>Data links and external URLs</u></i> are <b>disabled</b>.</li><li><i><u>Slack messages, file uploads, and emails</u></i> are <b>disabled</b>.</li><li><i><u>External site</u></i> is <b>excluded</b>. Production server is held at <a href="https://daslab.stanford.edu" target="_blank" rel="noopener noreferrer external">DasLab Website&nbsp;&nbsp;<span class="glyphicon glyphicon-new-window" aria-hidden="true"></span></a>.</li><br/><li><i><u>Static files and database</u></i> are restored to <b>default</b> every 30 min.</li><br/></ul>').insertAfter("#sys-msg");
